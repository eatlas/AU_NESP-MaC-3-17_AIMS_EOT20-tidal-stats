...
# Unzip load_tides.zip
load_tides_folder = os.path.join(base_path, "load_tides")
if os.path.exists(load_tides_folder):
    print(f"{load_tides_folder} found. Skipping...")
else:
    # The downloads already contain the load_tides subfolder and so we extract at the base_path
    unzip_file(load_tides_zip, base_path)
